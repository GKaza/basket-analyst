...
<template>
  <section class="relative viewport">
    ...
    <div v-if="team" class="py-8 mx-auto w-fit flex flex-col items-center gap-4 z-10">
      <img
    ...
    <div class="container mb-4">
      <p v-if="coach" class="text-zinc-700 font-bold drop-shadow-[0_35px_35px_rgba(255,255,255,0.35)]">
        <span v-if="coach.person.name">Head Coach - {{ coach.person.name }}</span>
      </p>
    </div>

    <div class="container overflow-hidden text-primary py-3 mb-4">
      <ul class="flex flex-wrap -mx-3">
        <li v-for="player in roster" class="player-card px-3 mb-6 w-full max-h-[600px] md:w-1/2 lg:w-1/4">
          <div class="card w-full h-full glass">
            ...
            <div class="card-body p-4 lg:p-8">
              ...
              <p>
                ...
                <span v-if="player.positionName"> - {{ player.positionName }} </span>
              </p>
